...
const hero: Dictionary = {
  "hero.eyebrow.first": "Accessible Innovation",
  ...
  "hero.cards.wcag-2.1-aa-oriented": "WCAG 2.1 AA accessibility",
  "hero.accessible-performance": "Performance & accessibility oriented",
