...
const welcome: Dictionary = {
  ...
  "welcome.a11yBody":
    "Quick adjustments — you can change these anytime in the floating panel.",
  "welcome.fontSize": "Font size",
  "welcome.font100": "100%",
  "welcome.font125": "125%",
  "welcome.reduceMotion": "Reduce motion",
  "welcome.configureMore": "Configure more settings",
